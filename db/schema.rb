...
ActiveRecord::Schema[7.1].define(version: 2026_01_15_055458) do
  ...
  create_table "buyings", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "items", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.integer "charged_by_id", null: false
  ...
  create_table "shippings", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["buying_id"], name: "index_shippings_on_buying_id"
  end
  ...
  add_foreign_key "shippings", "buyings"
end
